package ru.ds.magnitfaqchatbotauthserver.config;
...
import ru.ds.magnitfaqchatbotauthserver.interceptor.HttpLoggingInterceptor;
...
public class CommonConfiguration {
    ...
    static String SIMPLE_DATE_FORMAT = "yyyy-MM-dd'T'HH:mm:ss.SSSX";
